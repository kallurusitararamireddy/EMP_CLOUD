...
import com.cloud.qa.pages.LoginPage;
import com.cloud.qa.util.DeleteFilesInDirectory;
import com.cloud.qa.util.Helpers;
import com.cloud.qa.util.ReadConfig;
import com.cloud.qa.util.Screenshot;
...
public class TestBase {	
	...
	public TestBase() {
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream(System.getProperty("user.dir") + "/src/main/java/com/cloud" + "/qa/config/config.properties");
